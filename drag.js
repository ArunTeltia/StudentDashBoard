...
function dragStart(element) {
  ...
  element.addEventListener(
    ...
    function (e) {
      ...
      draggedElement.parentNode.style.left = touchLocation.pageX - xOffset + "px";
      draggedElement.parentNode.style.top = touchLocation.pageY - yOffset + "px";
    },
    { passive: true }
  );
  ...
  element.addEventListener(
    ...
    function (e) {
      ...
      var x = parseInt(draggedElement.parentNode.style.left);
      var y = parseInt(draggedElement.parentNode.style.top) - 5500;
    },
    { passive: true }
  );
}
